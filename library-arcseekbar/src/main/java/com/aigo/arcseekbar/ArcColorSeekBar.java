 ...
 */
public class ArcColorSeekBar extends View {
    ...
    private static final int DEFAULT_BORDER_COLOR = 0x00000000;     // 默认描边颜色
    ...
    private int mThumbCenterColor = 0xFFE8D30F;        // 拖动按钮颜色
    ...
    public ArcColorSeekBar(Context context) {
        this(context, null);
    }

    public ArcColorSeekBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ArcColorSeekBar(Context context, AttributeSet attrs, int defStyleAttr) {
...
//        mThumbPaint.reset();
        ...
        canvas.drawCircle(mThumbX, mThumbY, mThumbRadius, mThumbPaint);
        mThumbPaint.setAntiAlias(true);
        mThumbPaint.setColor(mThumbCenterColor);
        canvas.drawCircle(mThumbX, mThumbY, mThumbRadius/2+7, mThumbPaint);
        canvas.restore();
    ...
    private class OnClickListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onSingleTapUp(MotionEvent e) {
            ...
            // 事件回调
            if (null != mOnProgressChangeListener) {
                mOnProgressChangeListener.onProgressChanged(ArcColorSeekBar.this, getProgress(), true);
                mOnProgressChangeListener.onStopTrackingTouch(ArcColorSeekBar.this);
            }
            return true;
        }
    }
    ...
    public interface OnProgressChangeListener {
         ...
         */
        void onProgressChanged(ArcColorSeekBar seekBar, int progress, boolean isUser);
         ...
         * @param seekBar 拖动条
         */
        void onStartTrackingTouch(ArcColorSeekBar seekBar);
         ...
         * @param seekBar 拖动条
         */
        void onStopTrackingTouch(ArcColorSeekBar seekBar);
    }
